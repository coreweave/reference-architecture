...
Usage:
    from ailabs.remote_execution_helpers import run_remote, ssh_command, ssh
...
SSH_KEY = os.getenv("CW_AILABS_SSH_KEY_PATH", "/root/.ssh/id_rsa")
SSH_HOST = os.getenv("CW_AILABS_SSH_HOST", "")
...
def ssh(command: str, verbose: bool = True) -> str:
    """
...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1:
        ...
        print("Usage: python -m ailabs.remote_execution_helpers <command>")
        print("Example: python -m ailabs.remote_execution_helpers 'sinfo'")
